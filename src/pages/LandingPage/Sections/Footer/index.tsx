                ...
                <div className='flex w-full justify-between mb-[80px]'>
                    <div className='flex w-[730px] justify-between'>
                        ...
                        <div>
                            ...
                            <div className='flex'>
                                <img className='w-[12px] h-[12px]' src="/images/linkedin-icon.png" alt="Ícone do LinkedIn" />
                                <img className='w-[12px] h-[12px]' src="/images/facebook-icon.png" alt="Ícone do Facebook" />
                                <img className='w-[12px] h-[12px]' src="/images/instagram-icon.png" alt="Ícone do Instagram" />
                            </div>
                        </div>
                        <div className='flex flex-col'>
                            ...
                            <div className='flex flex-col mb-[24px]'>
                                <div className='flex w-[120px] items-center justify-between'>
                                    <img className='w-[31px] h-[9px]' src="/images/visa-brand.png" alt="Bandeira Visa" />
                                    <img className='w-[24px] h-[19px]' src="/images/mastercard-brand.png" alt="Bandeira Mastercard" />
                                    <img className='w-[24px] h-[24px]' src="/images/american-express-brand.png" alt="Bandeira American Express" />
                                </div>
                                <div className='flex w-[120px] items-center justify-between'>
                                    <img className='w-[29px] h-[12px]' src="/images/hipercard-brand.png" alt="Bandeira Hipercard" />
                                    <img className='w-[20px] h-[20px]' src="/images/elo-brand.png" alt="Bandeira Elo" />
                                    <img className='w-[27px] h-[16px]' src="/images/banescard-brand.png" alt="Bandeira Banescard" />
                                </div>
                                <div className='flex w-[120px] items-center justify-between'>
                                    <img className='w-[24px] h-[18px]' src="/images/jcb-brand.png" alt="Bandeira JCB" />
                                    <img className='w-[24px] h-[17px]' src="/images/diners-club-brand.png" alt="Bandeira Diners Club" />
                                    <img className='w-[29px] h-[10px]' src="/images/pix-brand.png" alt="Bandeira Pix" />
                                </div>
                            </div>
                    ...
                    <div>
                        <div>
                            <img className='mb-[20px]' src="/images/pci-dss-compliance-certification.png" alt="Certificação PCI DSS Compliant" />
                            <img src="/images/reclame-aqui-highest-rating-seal.png" alt="Selo de reputação máxima do Reclame aqui" />
                        </div>
                    </div>
                </div>
                <div className='flex w-full justify-between mb-[80px]'>
                    <p className='text-[12px] text-[#5E5873]'>Copyright @ 2022 mpays</p>
                    <img src="/images/mpays-logo.png" alt="Mpays Logo" />
                </div>
                <div>
