        ...
        <section className='flex justify-center mt-[-40px] mb-[130px]'>
            <div className='w-full max-w-6xl mx-14'>
                ...
                >
                    <SwiperSlide>
                        <CarouselCard
                            imageSrc='/src/assets/images/image-of-carousel-1.png'
                    ...
                    <SwiperSlide>
                        <CarouselCard
                            imageSrc='/src/assets/images/image-of-carousel-2.png'
                    ...
                    <SwiperSlide>
                        <CarouselCard
                            imageSrc='/src/assets/images/image-of-carousel-3.png'
                    ...
                    <SwiperSlide>
                        <CarouselCard
                            imageSrc='/src/assets/images/image-of-carousel-4.png'
